...
function Edit() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch(`https://pristine-paws-bd61149d81a0.herokuapp.com/${service_id}`)
    ...
    async function editAppt(e) {
        ...
        await fetch(`https://pristine-paws-bd61149d81a0.herokuapp.com/${service_id}`, {
            method: 'PUT',
            headers: {
